...
Every failure inside learn-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`learn.cli._output`,
...
# Exit-code policy. Documented in ``learn-cli learn`` output.
# 0      = success
