...
from learn.cli._errors import EXIT_USER_ERROR, CliError
from learn.cli._output import emit_error

_ISSUES_URL = "https://github.com/agentculture/learn-cli/issues"
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser = _CliArgumentParser(
        prog="learn-cli",
        description="learn-cli — a clonable template for AgentCulture mesh agents.",
    )
    parser.add_argument(
        "--version",
        action="version",
