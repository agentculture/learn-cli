...
- CI-synced Worker secrets: production and preview secrets are pushed from CI on every relevant run, keeping the deployed Worker config in lockstep with the repo.
